Below, I’ll guide you step-by-step through the process of inserting the given keys `[6, 3, 7, 5, 1, 2, 4]` into a **2-3-4 tree**, showing where splits and promotions occur.
